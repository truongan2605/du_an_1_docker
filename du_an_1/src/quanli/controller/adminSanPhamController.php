    ...
    public function postAddSanPham()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $file_thumb = uploadFile($anh, './upload/');
                ...
                header('location: ' . BASE_URL_QUANLI . '?act=san-pham');
                exit;
            } else {
                // dat chi thi cua sesion sau khi hien thi form 
                $_SESSION['flash'] = true;
                header('location: ' . BASE_URL_QUANLI . '?act=form-them-san-pham');
                exit();
            }
        }
    }
    ...
    public function postEditSanPham()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($errors)) {
                ...
                // dat chi thi cua sesion sau khi hien thi form 
                $_SESSION['flash'] = true;
                header('location: ' . BASE_URL_QUANLI . '?act=form-sua-san-pham&id_san_pham=' . $san_pham_id);
                exit();
            }
        }
    }
