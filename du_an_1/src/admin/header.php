            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav text-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="<?= BASE_URL_AMIN . '?act=list-tai-khoan-khach-hang' ?>">Tài khoản khách hàng </a>

                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="<?= BASE_URL_AMIN . '?act=thong-ke' ?>">Thống kê </a>
